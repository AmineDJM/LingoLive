...
export const LANGUAGES: readonly LanguageDefinition[] = [
  { code: 'ar', nativeName: 'العربية', englishName: 'Arabic', direction: 'rtl', searchTerms: ['arabic', 'arabe', 'arabisch', 'العربية'] },
  { code: 'bn', nativeName: 'বাংলা', englishName: 'Bengali', direction: 'ltr', searchTerms: ['bengali', 'bangla'] },
  { code: 'cs', nativeName: 'Čeština', englishName: 'Czech', direction: 'ltr', searchTerms: ['czech', 'cestina', 'tcheque'] },
  { code: 'da', nativeName: 'Dansk', englishName: 'Danish', direction: 'ltr', searchTerms: ['danish', 'dansk', 'danois'] },
  { code: 'de', nativeName: 'Deutsch', englishName: 'German', direction: 'ltr', searchTerms: ['german', 'deutsch', 'allemand', 'aleman'] },
  { code: 'el', nativeName: 'Ελληνικά', englishName: 'Greek', direction: 'ltr', searchTerms: ['greek', 'grec', 'ellinika'] },
  { code: 'en', nativeName: 'English', englishName: 'English', direction: 'ltr', searchTerms: ['english', 'anglais', 'ingles', 'englisch'] },
  { code: 'es', nativeName: 'Español', englishName: 'Spanish', direction: 'ltr', searchTerms: ['spanish', 'espanol', 'espagnol', 'castellano'] },
  { code: 'fa', nativeName: 'فارسی', englishName: 'Persian', direction: 'rtl', searchTerms: ['persian', 'farsi', 'perse'] },
  { code: 'fi', nativeName: 'Suomi', englishName: 'Finnish', direction: 'ltr', searchTerms: ['finnish', 'suomi', 'finnois'] },
  { code: 'fr', nativeName: 'Français', englishName: 'French', direction: 'ltr', searchTerms: ['french', 'francais', 'frances', 'franzosisch'] },
  { code: 'he', nativeName: 'עברית', englishName: 'Hebrew', direction: 'rtl', searchTerms: ['hebrew', 'hebreu', 'ivrit'] },
  { code: 'hi', nativeName: 'हिन्दी', englishName: 'Hindi', direction: 'ltr', searchTerms: ['hindi', 'hindawi'] },
  { code: 'hu', nativeName: 'Magyar', englishName: 'Hungarian', direction: 'ltr', searchTerms: ['hungarian', 'magyar', 'hongrois'] },
  { code: 'id', nativeName: 'Bahasa Indonesia', englishName: 'Indonesian', direction: 'ltr', searchTerms: ['indonesian', 'indonesien', 'bahasa'] },
  { code: 'it', nativeName: 'Italiano', englishName: 'Italian', direction: 'ltr', searchTerms: ['italian', 'italiano', 'italien'] },
  { code: 'ja', nativeName: '日本語', englishName: 'Japanese', direction: 'ltr', searchTerms: ['japanese', 'japonais', 'nihongo'] },
  { code: 'ko', nativeName: '한국어', englishName: 'Korean', direction: 'ltr', searchTerms: ['korean', 'coreen', 'hangugeo'] },
  { code: 'nl', nativeName: 'Nederlands', englishName: 'Dutch', direction: 'ltr', searchTerms: ['dutch', 'nederlands', 'neerlandais'] },
  { code: 'no', nativeName: 'Norsk', englishName: 'Norwegian', direction: 'ltr', searchTerms: ['norwegian', 'norsk', 'norvegien'] },
  { code: 'pl', nativeName: 'Polski', englishName: 'Polish', direction: 'ltr', searchTerms: ['polish', 'polski', 'polonais'] },
  { code: 'pt-BR', nativeName: 'Português (Brasil)', englishName: 'Portuguese (Brazil)', direction: 'ltr', searchTerms: ['portuguese', 'portugues', 'portugais', 'brasil', 'brazil'] },
  { code: 'pt-PT', nativeName: 'Português (Portugal)', englishName: 'Portuguese (Portugal)', direction: 'ltr', searchTerms: ['portuguese', 'portugues', 'portugais', 'portugal'] },
  { code: 'ro', nativeName: 'Română', englishName: 'Romanian', direction: 'ltr', searchTerms: ['romanian', 'romana', 'roumain'] },
  { code: 'ru', nativeName: 'Русский', englishName: 'Russian', direction: 'ltr', searchTerms: ['russian', 'russkiy', 'russe'] },
  { code: 'sv', nativeName: 'Svenska', englishName: 'Swedish', direction: 'ltr', searchTerms: ['swedish', 'svenska', 'suedois'] },
  { code: 'sw', nativeName: 'Kiswahili', englishName: 'Swahili', direction: 'ltr', searchTerms: ['swahili', 'kiswahili'] },
  { code: 'th', nativeName: 'ไทย', englishName: 'Thai', direction: 'ltr', searchTerms: ['thai', 'thailandais'] },
  { code: 'tr', nativeName: 'Türkçe', englishName: 'Turkish', direction: 'ltr', searchTerms: ['turkish', 'turkce', 'turc'] },
  { code: 'uk', nativeName: 'Українська', englishName: 'Ukrainian', direction: 'ltr', searchTerms: ['ukrainian', 'ukrainska', 'ukrainien'] },
  { code: 'ur', nativeName: 'اردو', englishName: 'Urdu', direction: 'rtl', searchTerms: ['urdu', 'ourdou'] },
  { code: 'vi', nativeName: 'Tiếng Việt', englishName: 'Vietnamese', direction: 'ltr', searchTerms: ['vietnamese', 'tieng viet', 'vietnamien'] },
  { code: 'zh-Hans', nativeName: '简体中文', englishName: 'Chinese (Simplified)', direction: 'ltr', searchTerms: ['chinese', 'chinois', 'mandarin', 'simplified', 'zhongwen'] },
  { code: 'zh-Hant', nativeName: '繁體中文', englishName: 'Chinese (Traditional)', direction: 'ltr', searchTerms: ['chinese', 'chinois', 'traditional', 'zhongwen'] },
] as const;

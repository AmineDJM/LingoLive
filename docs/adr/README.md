...
| [0011](0011-observability-without-a-vendor-sdk.md) | Optional observability without a vendor SDK                    | Accepted |
| [0012](0012-no-tanstack-query-in-web.md)           | No TanStack Query in the web app                               | Accepted |
